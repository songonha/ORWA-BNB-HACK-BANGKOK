...
import PropertyCarousel from "../../homes/home-one/PropertyCarousel"
                           ...
                           <div key={item.id} className="col-md-6 d-flex mb-50">
                              <div className="listing-card-one border-25 h-100 w-100">
                                 ...
                                 <div className="property-info p-25">
                                    <Link to="/dashboard/dashboard-index" className="title tran3s">{item.title}</Link>
                                    ...
                                    <div className="pl-footer top-border d-flex align-items-center justify-content-between">
                                       ...
                                       <Link to="/dashboard/dashboard-index" className="btn-four rounded-circle"><i className="bi bi-arrow-up-right"></i></Link>
                                    </div>
                                 </div>
                              </div>
                           </div>
