...
const compare_data: Datatype[] = [
   ...
   },
   {
      id: 2,
      tag: "For Sell",
      thumb: "/assets/images/listing/img_67.jpg",
      title: "Orkit Flat",
            ...
            <div className="row align-items-center">
               ...
               <div className="col-xl-3 col-lg-4 col-md-5 ms-auto">
                  <ul className="style-none d-flex align-items-center action-btns sm-mt-40">
                     ...
                     <li><Link to="#" className="d-flex align-items-center justify-content-center tran3s"><i className="fa-light fa-heart"></i></Link></li>
                     <li><Link to="#" className="d-flex align-items-center justify-content-center tran3s"><i className="fa-light fa-bookmark"></i></Link></li>
                     <li><Link to="#" className="d-flex align-items-center justify-content-center tran3s"><i className="fa-light fa-circle-plus"></i></Link></li>
                  </ul>
               </div>
            </div>
            ...
            <div className="compare-table mt-60 lg-mt-40">
               <div className="table-responsive table-bg bg-white">
                  <table className="table">
                     <thead>
                        <tr>
                           <td><img src="/assets/images/logo/logo_08.svg" alt="" className="lazy-img mt-50" /></td>
